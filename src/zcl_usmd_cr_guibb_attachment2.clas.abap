class ZCL_USMD_CR_GUIBB_ATTACHMENT2 definition
  public
...
protected section.
  ...
  methods PROCESS_LIST_CELL_ACTION
    redefinition .
private section.
*"* private components of class ZCL_USMD_CR_GUIBB_ATTACHMENT2
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCL_USMD_CR_GUIBB_ATTACHMENT2 IMPLEMENTATION.
